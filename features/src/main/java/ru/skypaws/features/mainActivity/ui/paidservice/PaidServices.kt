package ru.skypaws.features.mainActivity.ui.paidservice
...
import ru.skypaws.features.util.calendar
import ru.skypaws.features.util.logbookPay
import ru.skypaws.features.mainActivity.viewmodel.PaidServicesIntent
import ru.skypaws.features.mainActivity.viewmodel.PaidServicesViewModel
...
fun PaidServices(
    ...
    val state by paidServicesViewModel.state.collectAsState()
