...
import ru.skypaws.features.ui.theme.flight_flown
import ru.skypaws.features.ui.theme.flight_inProgress
...
fun Month(
    ...
    Row(
        ...
        Row(
            ...
            TextLogbookMedium(
                content = state.totalBlockByMonth[month] ?: "",
                modifier = Modifier.weight(1f)
            )

            TextLogbookMedium(
                content = state.totalFlightByMonth[month] ?: "",
                modifier = Modifier.weight(1f)
            )

            TextLogbookMedium(
                content = state.totalNightByMonth[month] ?: "",
                modifier = Modifier.weight(1f)
            )
...
@Composable
fun MonthPreview(
    month: YearMonthType = YearMonthType(2024, 8, 1),
    state: LogbookModel = LogbookModel(
        totalBlockByMonth = mapOf(month to "85:00"),
        totalFlightByMonth = mapOf(month to "70:30"),
        totalNightByMonth = mapOf(month to "30:10")
    ),
